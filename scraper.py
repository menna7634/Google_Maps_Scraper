...
def scrape_google_maps(search_query):
    """Scrapes Google Maps search results for businesses using BeautifulSoup and Requests."""
    ...
    try:
        ...
        response = requests.get(f'https://www.google.com/maps/search/{search_query}/', headers=headers)
        response.raise_for_status()

        # Parse the page content
        soup = BeautifulSoup(response.text, 'html.parser')

        # Scrolling and scraping data (you may need to adjust this part based on the structure of the Google Maps page)
